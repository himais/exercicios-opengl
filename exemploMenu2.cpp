...
//   glRotatef (b1, 1.0, 1.0, 0.0);
   glutWireSphere(20.0, 30, 16);   //raio, divisoes em torno e ao longo de z
  // glutWireCube(1.0); 			  //tamanho
   //glutWireCone(20, 50, 30, 160); 			  //raio, altura, divisoes
...
void reshape (int w, int h)
{
   ...
   gluPerspective(600000.0, (GLfloat) w/(GLfloat) h, 10.0, 20.0);
